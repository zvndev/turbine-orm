...
Use it for cache invalidation, live dashboards, and worker fan-out when you already have a Postgres connection and don't want to stand up Redis or a queue.
