...
const commentBodies = [
  ...
  'The deep type inference on `with` is what sold me.',
  'Have you benchmarked this against raw SQL? Curious about the overhead.',
  'We switched to this pattern last month and the type safety alone saved us hours.',
  'The code examples are really clear, thanks for sharing.',
  'One thing to note: LIMIT in nested with-clauses is important for large datasets.',
